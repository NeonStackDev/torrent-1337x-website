...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    public: {
      apiBase: 'https://1337x.website/api',
  ...
  critters: {
    ...
    preconnect: ['https://1337x.website'], // Preconectar a dominios necesarios
  },
  experimental: {
  ...
  app: {
    head: {
      ...
      link: [
        ...
        { rel: 'preconnect', href: 'https://1337x.website'},
      ...
      script: [
        {
          innerHTML: `
            var _Hasync = _Hasync || [];
            _Hasync.push(['Histats.start', '1,5054356,4,0,0,0,00010000']);
      ...
      noscript: [
        {
          innerHTML: '<a href="/" target="_blank"><img src="//sstatic1.histats.com/0.gif?5054356&101" alt="web statistics" border="0"></a>'
        },
      ],
    }
  },
  ...
  site: {
    url: 'https://1337x.website',
  },
  robots: {
    UserAgent: '*',
    Allow: '/',
    Sitemap: 'https://1337x.website/sitemap_index.xml'
  },
  sitemap: {
    ...
    sitemaps: {
      ...
      posts: {
        ...
        sources: [[
          'https://1337x.website/api/posts/slugs',
